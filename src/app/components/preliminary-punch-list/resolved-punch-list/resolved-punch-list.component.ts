...
@Component({
  selector: 'resolved-punch-list',
  templateUrl: './resolved-punch-list.component.html',
  styleUrls: ['./resolved-punch-list.component.scss']
})
export class ResolvedPunchListComponent implements OnInit {
  resolvedPunchList$: Observable<PreliminaryPunchList[]>;
  ...
  constructor(
    ...
    this.resolvedPunchList$ = this.punchListService.getEntries();
  }

  ngOnInit(): void {
    this.filterPunchLists(this.resolvedPunchList$);
  }
