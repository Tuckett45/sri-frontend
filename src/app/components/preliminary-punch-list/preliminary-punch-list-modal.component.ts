  ...
  save(): void {
    if (this.preliminaryPunchListForm.valid) {
      ...
      const formData: PreliminaryPunchList = {
        segmentId: this.preliminaryPunchListForm.get('vaultIssues')?.value,
        streetAddress: this.preliminaryPunchListForm.get('vaultIssues')?.value,
        city: this.preliminaryPunchListForm.get('vaultIssues')?.value,
        state: this.preliminaryPunchListForm.get('vaultIssues')?.value,
        ...
        additionalConcerns: this.preliminaryPunchListForm.get('vaultIssues')?.value,
        notifiedTo: this.preliminaryPunchListForm.get('vaultIssues')?.value,
        notifiedHow: this.preliminaryPunchListForm.get('vaultIssues')?.value,
        issueImage: this.preliminaryPunchListForm.get('vaultIssues')?.value,
