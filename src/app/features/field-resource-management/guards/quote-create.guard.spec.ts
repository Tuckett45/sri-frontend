...
import { QuoteCreateGuard } from './quote-create.guard';
import { AuthService } from '../../../services/auth.service';
import { FrmPermissionService } from '../services/frm-permission.service';
import { UserRole } from '../../../models/role.enum';

describe('QuoteCreateGuard', () => {
  let guard: QuoteCreateGuard;
  let authService: jasmine.SpyObj<AuthService>;
  let frmPermissionService: FrmPermissionService;
  let router: jasmine.SpyObj<Router>;

  const mockRoute: any = {};
  const mockState: any = { url: '/field-resource-management/quotes/new' };
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(QuoteCreateGuard);
  ...
  it('should deny access for MaterialsManager role', () => {
