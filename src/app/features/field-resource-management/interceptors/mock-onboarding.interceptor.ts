...
function buildMockCandidates(): Candidate[] {
  ...
  const statuses: OfferStatus[] = ['needs_review', 'vetted_available', 'offer_extended', 'offer_accepted_onboarding'];
  ...
  const raw: Array<{
    ...
    { name: 'Priya Patel', email: 'priya.patel@email.com', phone: '214-555-1002', vest: 'S', drug: true, osha: true, scissor: false, site: 'Plano Tech Center', homeState: 'TX', startOffset: 10, status: 'offer_extended' },
    { name: 'James O\'Connor', email: 'james.oconnor@email.com', phone: '972-555-1003', vest: 'XL', drug: false, osha: true, scissor: true, site: 'Irving Business Park', homeState: 'TX', startOffset: 3, status: 'offer_accepted_onboarding' },
    ...
    { name: 'Carlos Mendez', email: 'carlos.mendez@email.com', phone: '214-555-1005', vest: 'L', drug: true, osha: true, scissor: true, site: 'McKinney Site A', homeState: 'TX', startOffset: 7, status: 'vetted_available' },
    { name: 'Sarah Kim', email: 'sarah.kim@email.com', phone: '972-555-1006', vest: 'S', drug: false, osha: true, scissor: true, site: 'Richardson Data Center', homeState: 'TX', startOffset: 12, status: 'needs_review' },
    ...
    { name: 'Emily Zhang', email: 'emily.zhang@email.com', phone: '214-555-1008', vest: 'M', drug: true, osha: true, scissor: false, site: 'Carrollton Office', homeState: 'TX', startOffset: 20, status: 'needs_review' },
    { name: 'Robert Taylor', email: 'robert.taylor@email.com', phone: '972-555-1009', vest: 'XL', drug: false, osha: false, scissor: false, site: 'Grand Prairie Warehouse', homeState: 'TX', startOffset: 8, status: 'vetted_available' },
    { name: 'Maria Santos', email: 'maria.santos@email.com', phone: '469-555-1010', vest: 'M', drug: true, osha: true, scissor: true, site: 'Plano Tech Center', homeState: 'TX', startOffset: 4, status: 'offer_accepted_onboarding' },
    ...
    { name: 'Jasmine Lee', email: 'jasmine.lee@email.com', phone: '972-555-1012', vest: 'S', drug: false, osha: true, scissor: false, site: 'Fort Worth DC', homeState: 'TX', startOffset: 6, status: 'needs_review' },
    { name: 'Nathan Cooper', email: 'nathan.cooper@email.com', phone: '469-555-1013', vest: 'XL', drug: true, osha: false, scissor: true, site: 'McKinney Site A', homeState: 'TX', startOffset: 25, status: 'needs_review' },
    ...
    { name: 'Kwame Asante', email: 'kwame.asante@email.com', phone: '972-555-1015', vest: '2XL', drug: false, osha: false, scissor: false, site: 'Richardson Data Center', homeState: 'TX', startOffset: 11, status: 'needs_review' },
  ];
