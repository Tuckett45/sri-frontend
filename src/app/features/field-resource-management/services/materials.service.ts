...
export class MaterialsService {
  private readonly apiUrl = `${environment.atlasApiUrl}/materials`;
  private readonly purchaseOrderUrl = `${environment.atlasApiUrl}/purchase-orders`;
  private readonly supplierUrl = `${environment.atlasApiUrl}/suppliers`;
