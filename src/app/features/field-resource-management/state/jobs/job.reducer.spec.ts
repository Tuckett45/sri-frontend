...
describe('JobReducer', () => {
  ...
  describe('Load Jobs', () => {
    ...
    it('should set filters on loadJobs', () => {
      const filters = { region: 'TX', status: JobStatus.EnRoute };
      const action = JobActions.loadJobs({ filters });
      const state = jobReducer(initialState, action);
  ...
  describe('Create Job', () => {
    it('should set loading to true on createJob', () => {
      const action = JobActions.createJob({ 
        job: { siteName: 'New Job', description: 'Test' } as any 
      });
      const state = jobReducer(initialState, action);
  ...
  describe('Update Job', () => {
    ...
    it('should set loading to true on updateJob', () => {
      const action = JobActions.updateJob({ 
        id: mockJob.id, 
        job: { siteName: 'Updated Title' } as any 
      });
    ...
    it('should update job on updateJobSuccess', () => {
      const updatedJob = { ...mockJob, siteName: 'Updated Title' };
  ...
  describe('Filters', () => {
    it('should set filters on setJobFilters', () => {
      const filters = { region: 'TX', status: JobStatus.OnSite };
  ...
  describe('Entity Adapter', () => {
    it('should sort jobs by scheduledStart date', () => {
      const job1: Job = { ...mockJob, id: '1', scheduledStartDate: new Date('2024-02-03') };
      const job2: Job = { ...mockJob, id: '2', scheduledStartDate: new Date('2024-02-01') };
      const job3: Job = { ...mockJob, id: '3', scheduledStartDate: new Date('2024-02-02') };
      ...
      // Should be sorted by scheduledStartDate: job2, job3, job1
