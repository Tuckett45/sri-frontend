...
describe('TechnicianService', () => {
  ...
  describe('createTechnician', () => {
    ...
    it('should validate skills have name and level', () => {
      const invalidDto = { 
        ...validCreateDto, 
        skills: [{ id: 'skill-1', name: '', category: 'Technical' }] as Skill[]
      };
  ...
  describe('getTechnicianSkills', () => {
    it('should retrieve technician skills', () => {
      const mockSkills: Skill[] = [
        { id: 'skill-1', name: 'Fiber Installation', category: 'Technical' },
        { id: 'skill-2', name: 'Copper Splicing', category: 'Technical' }
      ];
  ...
  describe('addTechnicianSkill', () => {
    it('should add a skill to technician', () => {
      const newSkill: Skill = { id: 'skill-3', name: 'Aerial Work', category: 'Safety' };
