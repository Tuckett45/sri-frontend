...
describe('Job Selectors', () => {
  const mockJob1: Job = {
    ...
    requiredSkills: [
      { id: 'skill-1', name: 'Fiber Splicing', category: 'Installation' }
    ],
    notes: [],
    attachments: [],
  ...
  describe('Specialized Selectors', () => {
    ...
    it('should select today\'s jobs', () => {
      ...
      const result = JobSelectors.selectTodaysJobs.projector([todayJob, mockJob2, mockJob3]);
    ...
    it('should select overdue jobs', () => {
      ...
      const result = JobSelectors.selectOverdueJobs.projector([overdueJob, mockJob2, mockJob3]);
    ...
    it('should select upcoming jobs', () => {
      ...
      const result = JobSelectors.selectUpcomingJobs.projector([upcomingJob, mockJob2, mockJob3]);
  ...
  describe('Scope-Filtered Selectors', () => {
    ...
    describe('selectScopedJobsForMap', () => {
      it('should return jobs with location within scope', () => {
        ...
        expect(result[0].location).toEqual({ latitude: 32.7767, longitude: -96.7970 });
      });
    });
