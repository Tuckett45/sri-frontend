...
describe('Technician Selectors', () => {
  const mockTechnician1: Technician = {
    ...
    skills: [
      ...
      { id: 'skill-2', name: 'OTDR Testing', category: 'Testing' }
    ],
    certifications: [
      {
        id: 'cert-1',
  ...
  const mockTechnician2: Technician = {
    ...
    region: 'TX',
    skills: [
      { id: 'skill-3', name: 'Cable Installation', category: 'Installation' }
    ],
    certifications: [
      {
        id: 'cert-2',
  ...
  const mockTechnician3: Technician = {
    ...
    skills: [
      { id: 'skill-1', name: 'Fiber Splicing', category: 'Installation' },
      { id: 'skill-4', name: 'Project Management', category: 'Management' }
    ],
    certifications: [
      {
        id: 'cert-3',
